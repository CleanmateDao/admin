...
import { formatAddress, formatDate, getKycStatusLabel } from "../helpers/format";
      ...
      <div className="bg-card rounded-lg p-6 space-y-6 border border-border">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="text-foreground">{getKycStatusLabel(user.kycStatus)}</p>
          </div>
          <div>
